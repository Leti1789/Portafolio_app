        ...
        <div className="px-5 max-w-[1560px] mx-auto flex items-center justify-between pt-6 my-2">
          ...
          <div className="right flex items-center">
            <div
              ...
              <a href="/projects"><li className="text-[#ABB2BF] text-[32px] my-4 md:my-auto md:text-base list-none mx-4"><span className="text-[#C778DD] font-medium">#</span>work</li></a>
              ...
              <a href="contact"> <li className="text-[#ABB2BF] text-[32px] my-4 md:my-auto md:text-base list-none mx-4"><span className="text-[#C778DD] font-medium">#</span>contact</li></a>
              <div
                onClick={() => setToggle(false)}
                className="close absolute block md:hidden right-10 top-5">
                <img src={close} alt=""/>
              </div>
            </div> 
            {/*Close and opens btns*/}
            <div onClick={() => setToggle(true)} className="">
              <div className="open block  md:hidden w-12">
